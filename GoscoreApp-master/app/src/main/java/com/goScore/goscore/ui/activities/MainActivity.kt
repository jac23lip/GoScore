package com.goScore.goscore.ui.activities
...
import com.goScore.goscore.R
import com.goScore.goscore.data.db.GoscoreDb
import com.goScore.goscore.data.models.Team
import com.goScore.goscore.data.services.FootbalDataApiImp
import com.goScore.goscore.ui.items.*
import com.goScore.goscore.ui.model.*
import com.goScore.goscore.util.EndlessScrollListener
import com.goScore.goscore.util.SharedPreferencesUtil
...
class MainActivity : AppCompatActivity() {
    ...
    private suspend fun catchIOException(block: suspend () -> Unit) {
        try {
            ...
            Log.d(com.goScore.goscore.util.TAG, "catchIOException: ${e.message}")
        }
    }
